...
describe('User renderer', () => {
  ...
  test('should render correct data for all users if admin is rendering the list', () => {
    localStorage.setItem('userRole', 'admin');
  ...
  test('should render correct data for regular users if non-admin is rendering the list', () => {
    localStorage.setItem('userRole', 'user');
